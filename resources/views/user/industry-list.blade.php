                    ...
                    <div class="card-body p-4">
                        <div id="carouselExampleIndicators1" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                @if ($horImages1->isEmpty())
                                <div class="carousel-item active">
                                    <img class="d-block w-100 rounded" src="{{asset('images/advertisement.jpg')}}" alt="Default Image">
                                </div>
                                @else
                                {{ $imgCount = 0 }}
                                ...
                                <div class="carousel-item active">
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <img class="d-block w-100 rounded" src="https://www.jigarpublicity.com/assets/img/jigar-publicity-logo.png" alt="">
                                        @else
                                        <img class="d-block w-100 rounded" src="{{ asset($horImage->advertisment_image) }}" alt="">
                                        @endif
                                    </div>
                                    @endforeach
                                    @endif
                                </div>
                                <a class="carousel-control-prev" href="#carouselExampleIndicators1" data-bs-slide="prev"><span class="carousel-control-prev-icon"></span> <span class="sr-only">Previous</span> </a><a class="carousel-control-next" href="#carouselExampleIndicators1" data-bs-slide="next"><span class="carousel-control-next-icon"></span>
                        ...
                        <div class="card-body p-4">
                            <div id="carouselExampleIndicators2" class="carousel slide" data-bs-ride="carousel">
                                <ol class="carousel-indicators">
                                    ...
                                    <li data-bs-target="#carouselExampleIndicators2" data-bs-slide-to="{{ $index }}" class="{{ $index === 0 ? 'active' : '' }}"></li>
                                    @endforeach
                                </ol>
                                <div class="carousel-inner">
                                    @if ($horImages2->isEmpty())
                                    <div class="carousel-item active">
                                        <img class="d-block w-100 rounded" src="{{asset('images/advertisement.jpg')}}" alt="Default Image">
                                    </div>
                                    @else
                                ...
                                <a class="carousel-control-prev" href="#carouselExampleIndicators2" data-bs-slide="prev"><span class="carousel-control-prev-icon"></span> <span class="sr-only">Previous</span> </a><a class="carousel-control-next" href="#carouselExampleIndicators2" data-bs-slide="next"><span class="carousel-control-next-icon"></span>
                                    <span class="sr-only">Next</span></a>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tr onclick="fetchIndustryDetailsByUuid('{{ $industry->uuid }}')">
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <a href="#" class="btn btn-primary shadow btn-xs sharp me-1 view-btn" data-bs-toggle="modal" data-bs-target="#industryModal" data-image="{{ $industry->advertisment_image }}">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                    @endif
                                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                @if ($verImage == null)
                                <img class="img-fluid rounded" style="margin-bottom: 15px;" src="https://www.jigarpublicity.com/assets/img/jigar-publicity-logo.png" alt="">
                                @else
                                <img class="img-fluid rounded" style="margin-bottom: 15px;" src="{{ asset($verImage->advertisment_image) }}" alt="">
                                @endif
                            </div>
                        </div>
                        @endforeach
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-xxl-6 mb-3">
                                    <div class="product-detail-content">
                                        <div class="new-arrival-content mt-md-0 mt-3 pr">
                                            ...
                                            <p class="text-black">Industry Address: <span class="item" id="industryAddress"></span></p>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="industryModalLabel">Advertisement</h5><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <!-- Image Container --><img class="img-fluid rounded" id="modalIndustryImage" src="" alt="">
                        </div>
                    </div>
                </div>
            </div>
