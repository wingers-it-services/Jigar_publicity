                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-xxl-6 mb-3">
                                <div class="product-detail-content">
                                    <div class="new-arrival-content mt-md-0 mt-3 pr">
                                        ...
                                        <p class="text-black">Office Address: <span class="item" id="officeAddress"></span></p>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.status == 200) {
                    ...
                    document.getElementById('officeAddress').textContent = response.industries.office_address;
                    ...
                    response.contacts.forEach(contact => {
                        contactData = contactData +
                            ...
                            .mobile + '</span></p>' +
                            '<p class="text-black">Contact Email: <span class="item">' + contact.email_id + '</span></p>' +
                            '</div>' +
                            '</div>';
                    });
