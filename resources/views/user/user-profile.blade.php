                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="profile-blog mb-5">
                                ...
                                @else
                                <img src="{{ asset($horImage->advertisment_image) }}" alt="" class="img-fluid mt-4 mb-4 w-100">
                                @endif
                            </div>
                            @endforeach
                        </div>
                                    ...
                                    <div id="profile-settings" class="tab-pane fade active show">
                                        <div class="pt-3">
                                            <div class="settings-form">
                                                ...
                                                <form class="needs-validation" method="post" action="{{ route('updateUserDetails') }}" enctype="multipart/form-data" novalidate>
                                                    @csrf
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <select name="gender" class="form-control" required>
                                                                <option value="male" {{ $userDetail->gender == 'male' ? 'selected' : '' }}>
                                                                    Male</option>
                                                                <option value="female" {{ $userDetail->gender == 'female' ? 'selected' : '' }}>
                                                                    Female</option>
                                                                <option value="other" {{ $userDetail->gender == 'other' ? 'selected' : '' }}>
                                                                    Other</option>
                                                            </select>
                                                            <div class="invalid-feedback">
