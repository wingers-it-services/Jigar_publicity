                ...
                <div class="card">
                    <div class="card-body">
                        <div class="email-left-box generic-width px-0 mb-5">
                            <div class="p-0">
                                <a href="https://fito.dexignzone.com/laravel/demo/email-compose" class="btn btn-primary btn-block">Compose</a>
                            </div>
                            <div class="mail-list rounded mt-4">
                                <a href="https://fito.dexignzone.com/laravel/demo/email-inbox" class="list-group-item active"><i
