                                ...
                                <div class="col-xl-9 col-lg-6  col-md-6 col-xxl-7 col-sm-12">
                                    ...
                                    <div class="product-detail-content">
                                        ...
                                        <div class="new-arrival-content mt-md-0 mt-3 pr">
                                            ...
                                            <p class="text-black">Email: <span class="item"> {{$users->publication_email}}
                                            </p>
                    ...
                    <div class="card-body">
                        ...
                        <div class="default-tab">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " data-bs-toggle="tab" href="#home"><i class="la la-user me-2"></i>Book History</a>
                                </li>
