                                ...
                                <div class="row">
                                    <div class="col-xl-9">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="file" class="form-control" id="validationCustom01" accept="image/*" name="advertisment_image" onchange="previewImage(event)">
                                                <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="contact_no" type="text" required pattern="\d{10}" id="contact_no">
                                ...
                                <div class="row">
                                    <div class="col-xl-9">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="by_product" name="by_product">
                                                <div class="invalid-feedback">
