                                     ...
                                     <form id="editBookForm" action="{{ route('updateBook') }}" method="POST"
                                         ...
                                         <div class="modal-body">
                                             ...
                                             <div class="mb-3">
                                                 ...
                                                 <input type="number" class="form-control" id="editBookPrice"
                                 ...
                                 <table id="example3" class="display min-w850">
                                     ...
                                     <tbody>
                                         @foreach ($books as $book)
                                             <tr>
                                                 <td>
                                                     <img width="80" src="{{ asset($book->image) }}"
                                                 ...
                                                 <td>&#8377; <a
                                                         href="javascript:void(0);"><strong>{{ $book->book_price }}</strong></a>
                                                 </td>
                                                 <td>2011/04/25</td>
                                                 <td>
                                                     <div class="d-flex">
                                                         <a href="/admin/book-details/{{ $book->uuid }}"
                                                         ...
                                                         <a href="/admin/delete-book/{{ $book->uuid }}"
         ...
         document.addEventListener('DOMContentLoaded', function() {
             ...
             editButtons.forEach(function(button) {
                 button.addEventListener('click', function() {
                     ...
                     document.getElementById('selected_image').src = '{{ asset('') }}' + book
                         .image;
                     document.getElementById('editBookImage').value = '{{ asset($book->image) }}' +
                         book.image; // Reset the file input
