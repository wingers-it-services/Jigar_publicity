                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="no_of_device" placeholder=""
                                            name="no_of_device" required="">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control" id="number_of_hours" placeholder=""
                                            name="number_of_hours" required="">
                                        <div class="invalid-feedback">
                                ...
                                <button class="btn btn-primary btn-lg btn-block" id="checkout-button"
                                    type="submit">Continue to Pay</button>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <ul class="list-group mb-3">
                                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                                        <div>
                                            <h6 class="my-0"><span id=""></span>PER HOUR PRICE <span
                                                    id="price_per_hour_span">0</span> X <span id="hours">0</span> Hours:
                                            </h6>
                                        </div>
                                    ...
                                    <tbody id="orders">
                                        @foreach ($userPayments as $payment)
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge badge-{{ $payment->payment_status == \App\Enums\PaymentStatus::PAID ? 'success' : 'warning' }} badge-sm light">
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <button
                                                            class="btn btn-primary shadow btn-xs sharp me-1 edit-payment-button"
