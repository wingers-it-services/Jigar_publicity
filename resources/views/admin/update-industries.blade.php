                                ...
                                <div class="form-validation">
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="file" class="form-control" id="validationCustom01"
                                                        ...
                                                        name="advertisment_image" onchange="previewImage(event)">
                                                    <div class="invalid-feedback">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-2">
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="email" value="{{ $industryDetails->email }}"
                                        ...
                                        <div class="col-lg-6 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ $industryDetails->web_link }}" id="web_link"
                                                    name="web_link">
                                                ...
                                                <div class="col-lg-9 d-inline-flex align-items-center flex-wrap-nowrap">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            {{ $industryDetails->industry_type == 'service-based' ? 'checked' : '' }}
                                                            required>
                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    <div class="row">
                                        <div class="col-xl-9">
                                            <div class="mb-3 row">
                                                <label class="col-lg-4 col-form-label" for="product">Product Name <span
                                                        class="text-danger">*</span></label>
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control"
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" id="service_type"
                                                        value="{{ $industryDetails->product }}" name="product">
                                            ...
                                            <div class="col-lg-3 mt-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" id="email_id"
                                                        value="{{ $contact->email_id }}" name="email_id[]">
                                                    <div class="invalid-feedback">
                                                        Please enter a valid email.
                                                    </div>
                                                </div>
