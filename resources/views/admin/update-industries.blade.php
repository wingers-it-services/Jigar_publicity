                            ...
                            <div class="form-validation">
                                <div class="row">
                                    <div class="col-xl-9">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="file" class="form-control" id="validationCustom01" value="{{$industryDetails->advertisment_image}}" accept="image/*" name="advertisment_image" onchange="previewImage(event)" required>
                                                <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-2">
                                        ...
                                        <div class="invalid-feedback">No categories available. Please add a category first.</div>
                                        @else
                                    ...
                                    <div class="col-lg-6 mb-2">
                                        ...
                                        @if($areas->isEmpty())
                                        <div class="invalid-feedback">No areas available. Please add an area first.</div>
                                        @else
                            ...
                            <div class="form-validation">
                                <div class="row">
                                    <div class="col-xl-9">
                                        ...
                                        <div class="mb-3 row">
                                            <label class="col-lg-4 col-form-label" for="raw_material">Raw Material</label>
                                            <div class="col-lg-8">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4 mt-3">
                            <div class="form-group">
                                <label>Contact Name</label>
                                <input class="form-control" name="contact_name[]" value="" type="text" required>
                                <div class="invalid-feedback">
                                    Please enter the contact name.
                                </div>
                            </div>
