    ...
    @section('content')
        ...
        <div class="content-body ">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form class="needs-validation" action="{{ route('addUserByadmin') }}" method="POST"
                                    ...
                                    <div class="form-validation">
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <select class="default-select wide form-control"
                                                            id="validationCustom03" name="gender" required>
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-lg-4 col-form-label"
                                                        for="validationCustom05">Account
                                                        Status
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <div class="col-lg-6">
                                                        <select class="default-select wide form-control"
                                                            id="validationCustom05" name="account_status" required>
                                                            <option data-display="Select">Please select</option>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="mb-3 row">
                                                        <label class="col-lg-4 col-form-label"
                                                            for="validationCustom01">Company
                                                            Name
                                                            <span class="text-danger">*</span>
                                                        </label>
                                                        <div class="col-lg-6">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <textarea type="text" class="form-control" id="validationCustom01" name="company_address"
                                                                placeholder="Enter a Company Address.." required></textarea>
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="mb-3 row">
                                                        <label class="col-lg-4 col-form-label" for="validationCustom05">No
                                                            of
                                                            Device
                                                            Allowed </label>
                                                        <div class="col-lg-6">
                                                            <select class="default-select wide form-control"
                                                                id="validationCustom05" name="no_of_device" required>
                                                                <option data-display="Select">Please select</option>
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <select class="default-select wide form-control"
                                                                id="validationCustom05" name="no_of_hour" required>
                                                                <option data-display="Select">Please select</option>
                                                                <option value="1">1</option>
                                                                <option value="2">2</option>
                                                                <option value="3">3</option>
                                                    ...
                                                    <div class="mb-3 row">
                                                        <label class="col-lg-4 col-form-label"
                                                            for="validationCustom05">Payment
                                                            Status </label>
                                                        <div class="col-lg-6">
                                                            <select class="default-select wide form-control"
                                                                id="validationCustom05" name="payment_status" required>
                                                                <option data-display="Select">Please select</option>
                                                                <option value="{{ \App\Enums\PaymentStatus::PAID }}">Paid
                                                                </option>
                                                                <option value="{{ \App\Enums\PaymentStatus::PENDING }}">
                                                                    Pending
                                                                </option>
                                                            </select>
                                                            <div class="invalid-feedback">
