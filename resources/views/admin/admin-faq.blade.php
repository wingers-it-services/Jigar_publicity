                    ...
                    <div class="card">
                        ...
                        <div class="card-body" id="cardBody3" style="display: none;">
                            ...
                            <ol>
                                ...
                                <li>4. Fill in the industry details. The fields highlighted with a red star are mandatory.
                                </li>
                                <li>5. If you want to add multiple contacts, click on the "Add Contacts" button at the end
                                    of the form. You can click this button multiple times to add as many contacts as needed.
                                </li>
                                <li>6. Finally, click on "Save". Your industry will be added and listed in the industry
                                    table.</li>
                            </ol>
                            </p>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" id="cardBody4" style="display: none;">
                            ...
                            <ol>
                                ...
                                <li>8. To view the newly added user, click on the "User List" sub-menu in the "Users" menu.
                                </li>
                            </ol>
                            </p>
                        </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body" id="cardBody5" style="display: none;">
                            ...
                            <ol>
                                <li>1. Click on the three horizontal lines located beside the main navbar at the upper left
                                    side of the page.</li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" id="cardBody7" style="display: none;">
                            ...
                            <ol>
                                ...
                                <li>2. You will see a list of users with details including their name, email, contact
                                    number, payment date, and payment status.</li>
                            </ol>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" id="cardBody8" style="display: none;">
                            ...
                            <ol>
                                ...
                                <li>3. A pop-up input box will appear. Upload the advertisement image and select the image
                                    type (horizontal or vertical).</li>
                                <li>4. Click on the "Save" button.</li>
                                <li>5. The advertisement will be added successfully and listed in the table. It will also be
                                    displayed to user on the industry list page.</li>
                            </ol>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" id="cardBody9" style="display: none;">
                            ...
                            <ol>
                                ...
                                <li>2. You will see a list of login histories for all users, including their names, email
                                    addresses, device types used for logging in, IP addresses, login dates, and the cities
                                    and states from which they logged in, among other details.</li>
                            </ol>
                            </p>
                        </div>
                    </div>
