		...
		<div class="deznav">
			<div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li>
						<a href="/subscription-list" class="ai-icon" aria-expanded="false">
					...
					<li><a class="has-arrow ai-icon" href="javascript:void(0)" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="/add-gym-staff">Add New Book</a></li>
							<li><a href="/gym-staff">Books List</a></li>
							<li><a href="/staff-details">Books Details</a></li>
						</ul>
					</li>
					...
					<li><a class="has-arrow ai-icon" href="javascript:void(0)" aria-expanded="false">
						...
						<ul aria-expanded="false">
							<li><a href="/gym-user-list">Users List</a></li>
							<li><a href="/add-gym-user">Add New User</a></li>
							<li><a href="/gym-customers-subscription-payment">Payment Details</a></li>
						</ul>
					</li>
					<li>
						<a href="/calendar">
