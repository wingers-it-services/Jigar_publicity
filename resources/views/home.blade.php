...
<head>
	...
	<meta name="description" content="Discover Fito, the ultimate fitness solution designed to help you achieve a healthier lifestyle. With its cutting-edge features and personalized programs, Fito provides the perfect blend of exercise, nutrition, and motivation. Start your fitness journey today with Fito! Visit DexignZone for more information.">

	<meta property="og:title" content="Fito - A Comprehensive Fitness Solution for a Healthier Lifestyle | DexignZone">
	<meta property="og:description" content="Discover Fito, the ultimate fitness solution designed to help you achieve a healthier lifestyle. With its cutting-edge features and personalized programs, Fito provides the perfect blend of exercise, nutrition, and motivation. Start your fitness journey today with Fito! Visit DexignZone for more information.">
...
<div class="page-wraper">
    ...
    <div class="page-content bg-white">
				...
				<div class="wl-content">
					...
					<!-- <div class="wl-nav">
						<ul>
							...
							<li><a href="doc/index.html" target="bank">Documentation</a></li>
						</ul>
					</div> -->
					<div class="wl-bynw">
				...
				<div class="row align-items-center">
					<div class="col-md-12 col-lg-4">
						...
						<div class="testimonial-one-navigation owl-clienr-btn">
							...
							<span id="prev-slide" class="btn next"><i class="las la-long-arrow-alt-right"></i></span>
						</div>
					</div>
        ...
        <!-- <div class="section-full bg-gray bg-img-fix content-inner " id="demo">
            <div class="container-fluid">
				<div class="section-head title-box text-center" data-name="Dashboard">
					<h2>Pre Build Dashboard Demos</h2>
					<h6>Awesome Admin Dashboard</h6>
					<div class="bg-primary dlab-separator"></div>
				</div>
				<div class="row sp50">
					<div class="col-md-6 col-lg-6 col-sm-6">
						<div class="demo-box box-demo">
								<div class="dz-tech">
								<ul>
									<li><a target="_blank" class="tech-html active" href="xhtml/index.html">
									...
									<li><a target="_blank" class="tech-react" href="react/demo/dashboard.html">
							...
							<div class="demo-area">
								<a href="xhtml/index.html" class="demo-media" target="_blank">
									<img src="welcome/images/demo/index.jpg">
								</a>
								<div class="demo-info">
									<h4 class="dz-title"><a href="xhtml/index.html" target="_blank">Dashboard Light</a></h4>
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-6 col-lg-6 col-sm-6">
						<div class="demo-box box-demo">
							<div class="dz-tech">
								<ul>
									<li><a target="_blank" class="tech-html active" href="xhtml/index-2.html">
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 409.6 409.6">
											<path d="M0,0l34.135,375.465L204.8,409.6l170.665-34.135L409.6,0H0z M343.788,346.998L204.8,374.784L65.812,346.998L37.361,34.135
												h334.848L343.788,346.998z" fill="#fff"></path>
											<polygon points="334.833,68.265 74.752,68.265 88.714,221.865 286.602,221.865 280.402,290.063 204.8,305.167 129.183,290.063 
									...
									<li><a target="_blank" class="tech-laravel" href="laravel/demo/index-2.html">
										<svg fill="#fff" viewBox="0 0 512 512" xmlns="../www.w3.org/2000/svg.html">	<path d="M505.57,234.62c-3.28-3.53-26.82-32.29-39.51-47.79-6.75-8.24-12.08-14.75-14.32-17.45l-.18-.22-.2-.21c-5.22-5.83-12.64-12.51-23.78-12.51a39.78,39.78,0,0,0-5.41.44c-.37.05-.75.11-1.15.15-2.45.27-10.06,1.5-28.14,4.48-14,2.29-35.11,5.77-38.31,6.07l-.71.06-.69.13c-10,1.78-16.62,6.22-19.56,13.19-1.55,3.68-3.22,11.15,2.94,19.86,1.53,2.22,6.83,9.56,15.94,22.17,6.06,8.4,12.87,17.82,18.75,26L259.9,275,150.66,96.05l-.2-.34-.23-.33-.44-.65C145.32,88.17,139.76,80,123.7,80h0c-1.13,0-2.31,0-3.63.11-4.6.25-21.42,1.57-40.89,3.11-21.49,1.69-50.9,4-54.72,4.1h-.73l-.79.08c-9.14.89-15.77,4.6-19.7,11-6.55,10.69-1.42,22.69.26,26.63C6.87,133,37.56,197.7,64.63,254.81c18,37.94,36.58,77.17,38.1,80.65a34.85,34.85,0,0,0,32.94,21.59,46.62,46.62,0,0,0,9.86-1.1l.21,0,.2-.05c13.86-3.38,57.83-14.54,89.2-22.59,1.9,3.32,3.9,6.83,6,10.44,21.93,38.5,37.9,66.35,43.16,73.46C287,421,295,432,310.06,432c5.46,0,10.46-1.4,15.74-2.89l1.53-.43.06,0h.06c10.53-3,150.69-52.16,157.87-55.35l.22-.1c5.44-2.41,13.66-6.05,16.18-15.4,1.65-6.12.18-12.33-4.38-18.46l-.07-.09-.07-.09c-.85-1.1-4-5.21-8.27-10.9-9.13-12.07-23.88-31.57-36.84-48.54,17.37-4.5,38.8-10.11,43.38-11.55,11.47-3.43,14.94-10.69,16-14.73C512.26,250.32,513.29,242.27,505.57,234.62Zm-320,58.19c-17.81,4.17-30.22,7.08-37.89,8.9-6.67-13.34-19.74-39.65-32.5-65.33C85.44,176.46,70.08,145.61,62,129.48l8.15-.7c13.34-1.15,31.61-2.72,41.78-3.57,16.76,28.26,74.32,125.3,96.3,162.3ZM427.58,172h0ZM310.06,416.4h0Zm53.67-56.95c-24.21,8-37.33,12.37-44.42,14.74-6.3-10.34-20.16-33.52-32.47-54.19l115.7-29.48c5,6.81,14.57,19.72,33.46,44.93C417.93,341.49,387.8,351.47,363.73,359.45ZM419.6,237.82l-23.76-31.53c13.67-2.39,21.54-3.77,26.15-4.6l12,14.88,11.94,14.82C437.73,233.38,428.19,235.71,419.6,237.82Z"></path></svg>
									Laravel</a></li>
									<li><a target="_blank" class="tech-react" href="react/index.html">
										<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48.746 48.746">
											<path d="M48.746,24.605c0-3.513-4.426-6.065-10.495-7.562c2.078-5.377,2.44-10.031-0.244-12.021
											c-0.735-0.545-1.642-0.821-2.692-0.821c-3.135,0-7.463,2.515-11.919,6.696c-4.505-4.464-8.874-7.16-11.989-7.16
											c-0.953,0-1.78,0.247-2.461,0.734c-2.11,1.514-2.42,4.939-0.895,9.905c0.299,0.974,0.676,1.99,1.099,3.027
							...
							<div class="demo-area new">
								<a href="xhtml/index-2.html" class="demo-media" target="_blank">
									<img src="welcome/images/demo/index2.jpg">
								</a>
								<div class="demo-info">
									<h4 class="dz-title"><a href="xhtml/index-2.html" target="_blank">Dashboard Dark</a></h4>
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-6 col-lg-4 col-sm-6">
						<div class="demo-box box-demo">
							<div class="demo-area">
								<a href="xhtml/workout-plan.html" class="demo-media" target="_blank">
									<img src="welcome/images/demo/workout-plan.jpg">
								</a>
								<div class="demo-info">
									<h4 class="dz-title"><a href="xhtml/workout-plan.html" target="_blank">Workout Plan</a></h4>
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-6 col-lg-4 col-sm-6">
						<div class="demo-box box-demo">
							<div class="demo-area">
								<a href="xhtml/distance-map.html" class="demo-media" target="_blank">
									<img src="welcome/images/demo/distance-map.jpg">
								</a>
								<div class="demo-info">
									<h4 class="dz-title"><a href="xhtml/distance-map.html" target="_blank">Distance Map</a></h4>
								</div>
							</div>
						</div>
					</div>
					<div class="col-md-6 col-lg-4 col-sm-6">
						<div class="demo-box box-demo">
							<div class="demo-area">
								<a href="xhtml/food-menu.html" class="demo-media" target="_blank">
									<img src="welcome/images/demo/food-menu.jpg">
								</a>
								<div class="demo-info">
									<h4 class="dz-title"><a href="xhtml/food-menu.html" target="_blank">Diet Food Menu</a></h4>
								</div>
							</div>
						</div>
					</div>
		...
		<!-- <div class="section-full content-inner-1">
			<div class="container-fluid">
				...
				<div class="inner-frame owl-carousel owl-btn-center-lr owl-btn-3 m-b30">
					<div class="item">
						<div class="layout-type phone">
							<a href="xhtml/index.html" target="_bank">
								<div class="media">
									<img src="welcome/images/inner-page/home.jpg" alt=""/>
								</div>
								<div class="dz-title">Home 1</div>
							</a>
						</div>
					</div>
					<div class="item">
						<div class="layout-type tab">
							<a href="xhtml/index.html" target="_bank">
								<div class="media">
									<img src="welcome/images/inner-page/home-mobile.jpg" alt=""/>
								</div>
								<div class="dz-title">Home 1</div>
							</a>
						</div>
					...
					<div class="item">
						<div class="layout-type phone">
							<a href="xhtml/ecom-product-grid.html" target="_bank">
								<div class="media">
									<img src="welcome/images/inner-page/ecom-product-grid.jpg" alt=""/>
								</div>
								<div class="dz-title">Product Grid</div>
							</a>
						</div>
					</div>
					<div class="item">
						<div class="layout-type tab">
							<a href="xhtml/ecom-product-grid.html" target="_bank">
								<div class="media">
									<img src="welcome/images/inner-page/ecom-product-grid-mobile.jpg" alt=""/>
								</div>
								<div class="dz-title">Product Grid</div>
							</a>
						</div>
		...
		<hr/>
		<!-- <div class="section-full content-inner relative bg-white bg-img-fix">
			<div class="section-head title-box text-center" data-name="Elements">
				<h2>Elements</h2>
				<h6>100+ Elements Style</h6>
				<div class="bg-primary dlab-separator"></div>
			</div>
		...
		<!-- <div class="section-full content-inner bg-white content-inner" style="background-image:url(welcome/images/axiom-pattern.png)">
			<div class="container-fluid">
				<div class="section-head title-box text-center" data-name="OPTIMIZED">
					...
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-3">
						<div class="pagespeed">
							...
							<div class="info">
								...
								<p class="score">Score <span>90%</span></p>
							</div>
						</div>
					</div>
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-3">
						<div class="pagespeed">
							...
							<div class="info">
								...
								<p class="score">Score <span>95%</span></p>
							</div>
						</div>
					</div>
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-3">
		...
		<!-- <div class="section-full video-presentation overlay-primary bg-img-fix" style="background-image:url(xhtml/page-error-404.html);">
			<div class="container-fluid">
				<div class="d-flex align-items-center">
					<div class="mr-auto text-white">
						<h2 class="m-tb10"><span class="font-weight-400">Buy Now </span> Fito</h2>
					</div>
					<div class="m-tb10">
						<a href="../www.ojrq.net/p/indexfb69.html" target="blank" class="site-button radius-xl button-md white">Buy Now</a>
					</div>
				</div>
			</div>
		</div> -->
		<!-- <div class="section-full customize text-black content-inner" style="background-position:bottom; background-size:100%; background-repeat:no-repeat" id="SupportSection">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12 text-center">
						...
						<h3 class="text-black">SOLUTION IS <a target="_blank" href="../support.w3itexperts.com/index.html"><span class="text-primary font-weight-700">HIRE DexignZone</span></a></h3>
						<div class="hire">
							...
							<div class="m-t20">
								<a href="../www.ojrq.net/p/indexfb69.html" target="_blank" class="site-button radius-xl m-r10 button-md">Buy Now</a>
								<a href="../support.w3itexperts.com/index.html" target="_blank" class="site-button black button-md radius-xl"><i class="fa fa-envelope-o m-r5"></i> Support</a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container-fluid text-center">
				<div class="news-letter">
					...
					<div class="subscribe-form m-b20">
						<form class="dzSubscribe dezPlaceAni" action="https://fito.dexignzone.com/welcome/script/mailchamp.php" method="post">
				...
				<div class="requirement">
					...
					<h3>Write us at <a href="../support.w3itexperts.com/index.html" target="_blank">DexignZone Support</a></h3>
				</div>
			</div>
		</div> -->
		...
		<div class="footer-top">
            <!-- <div class="container">
               <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="widget widget_about">
							<h4 class="footer-title"><img src="welcome/images/elite.svg" width="30" class="mr-2" alt="">6 Years+ Envato Exclusive Author</h4>
					...
					<div class="col-lg-3 col-sm-6">
                        <div class="widget widget_about">
							<h4 class="footer-title">Customers Feedback Appreciative</h4>
